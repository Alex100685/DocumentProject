      ...
      <thead>
        <tr>
            ...
            <th style="width: 150px; "><b>Action</b></th>
            	 ...
            	 <c:forEach items="${all[0]}" var="receiver">
            <tr>
            	<td>${receiver.id}</td>
            	...
            	<td>${receiver.name}</td>
            	 ...
            	 <td>
            	 <a class="DeleteButton" href="/admin/deleteReceiver?id=${receiver.id}"><img src="https://cdn2.iconfinder.com/data/icons/windows-8-metro-style/26/trash.png"></a>
            	 </td>
