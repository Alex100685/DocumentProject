...
<div class="container">
    ...
    <form role="form" enctype="multipart/form-data" class="form-horizontal" action="/admin/upload" method="post">
        ...
        <div><input type="text" class="form-control" name="inventaryNumber" value="${document.inventaryNumber}" placeholder="Number in section" style="width: 429px; " readonly></div>
