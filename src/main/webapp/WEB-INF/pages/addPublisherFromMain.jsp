...
<div class="form-group"><input type="text" class="form-control" name="nameOfPublisher" required="required" pattern="[а-яА-ЯёЁa-zA-Z0-9]{1,1000}" title="Must be not empty" placeholder="Name of publisher" style="width: 327px; "></div>
