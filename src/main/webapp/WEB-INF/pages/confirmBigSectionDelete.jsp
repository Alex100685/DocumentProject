...
<body>
<div class="container">
<h3>${bs.name} contains one or more sections inside which will be deleted!!!</h3>

<form class="form-group" action="/admin/deleteBSAnyway" style="width: 140px; ">

<div class="form-group"><input type="text" class="form-control" value="${bs.id}" name="bsId" style="width: 429px; " readonly></div>
<div class="form-group"><input type="text" class="form-control" value="${bs.name}" name="bsName" style="width: 429px; " readonly></div>
