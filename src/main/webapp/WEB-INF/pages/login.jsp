              ...
              <div class="col-lg-12">
                <form id="login-form" action='${loginUrl}' method="post" role="form" style="display: block;">
                  <div class="form-group">
                    <input type="text" name="username" id="j_username" tabindex="1" class="form-control" placeholder="Login">
                  </div>
                  <div class="form-group">
                ...
                <form id="register-form" action="/registration" method="post" role="form" style="display: none;">
                  <div class="form-group">
                    <input type="text" name="login" id="username" tabindex="1" class="form-control" placeholder="Login" value="" required>
                  </div>
                  <div class="form-group">
